...
import { CdrModel } from '../../models/ivoip/cdr.model';

@Component({
  selector: 'ngx-pstn-numbers',
  templateUrl: './pstn-numbers.component.html',
  styleUrls: ['./pstn-numbers.component.scss']
})
export class PstnNumbersComponent implements OnInit {
