...
import { SmartTableCurrencyComponent, SmartTableDateTimeComponent, SmartTableBaseComponent, SmartTableButtonComponent, SmartTableTagsComponent, SmartTableRelativeVouchersComponent } from '../../../../../lib/custom-element/smart-table/smart-table.component';
        ...
        State: {
          ...
          onComponentInitFunction: (instance: SmartTableButtonComponent) => {
            ...
            instance.valueChange.subscribe(value => {
              ...
              instance.label = instance.title = this.cms.translateText(processMap?.label || '');
