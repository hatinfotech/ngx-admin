...
export class PurchaseOrderVoucherListComponent extends AgGridDataManagerListComponent<PurchaseOrderVoucherModel, PurchaseOrderVoucherFormComponent> implements OnInit {
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: PurchaseOrderVoucherModel[]) => void, onDialogClose?: () => void) {
    this.cms.openDialog(PurchaseOrderVoucherFormComponent, {
      context: {
        inputMode: 'dialog',
        inputId: ids,
        onDialogSave: (newData: PurchaseOrderVoucherModel[]) => {
