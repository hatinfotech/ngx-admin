...
@Component({
  selector: 'ngx-multifunctional-purchase-supplier-print',
  templateUrl: './multifunctional-purchase-supplier-print.component.html',
  styleUrls: ['./multifunctional-purchase-supplier-print.component.scss'],
})
export class MultifunctionalPurchaseSupplierPrintComponent extends DataManagerPrintComponent<MultifunctionalPurchaseModel> implements OnInit {

  /** Component name */
  componentName = 'MultifunctionalPurchaseSupplierPrintComponent';
  title: string = '';
  env = environment;
  ...
  constructor(
    ...
    public ref: NbDialogRef<MultifunctionalPurchaseSupplierPrintComponent>,
