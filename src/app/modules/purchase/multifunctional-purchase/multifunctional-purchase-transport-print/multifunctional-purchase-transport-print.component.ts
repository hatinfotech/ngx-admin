...
@Component({
  ...
  templateUrl: './multifunctional-purchase-transport-print.component.html',
  styleUrls: ['./multifunctional-purchase-transport-print.component.scss'],
})
export class MultifunctionalPurchaseTransportPrintComponent extends DataManagerPrintComponent<MultifunctionalPurchaseModel> implements OnInit {

  /** Component name */
  componentName = 'MultifunctionalPurchaseTransportPrintComponent';
  title: string = '';
  env = environment;
  ...
  constructor(
    ...
    public ref: NbDialogRef<MultifunctionalPurchaseTransportPrintComponent>,
