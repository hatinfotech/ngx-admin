...
@Component({
  ...
  templateUrl: './purchase-product-form.component.html',
  styleUrls: ['./purchase-product-form.component.scss'],
})
export class PurchaseProductFormComponent extends DataManagerFormComponent<PurchaseProductModel> implements OnInit {
  ...
  /** Execute api get */
  executeGet(params: any, success: (resources: PurchaseProductModel[]) => void, error?: (e: HttpErrorResponse) => void) {
  ...
  onAddFormGroup(index: number, newForm: FormGroup, formData?: PurchaseProductModel): void {
  ...
  async save(): Promise<PurchaseProductModel[]> {
