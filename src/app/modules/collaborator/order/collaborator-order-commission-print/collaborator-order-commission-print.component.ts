...
@Component({
  selector: 'ngx-collaborator-order-commission-print',
  templateUrl: './collaborator-order-commission-print.component.html',
  styleUrls: ['./collaborator-order-commission-print.component.scss']
})
export class CollaboratorOrderCommissionPrintComponent extends DataManagerPrintComponent<CollaboratorOrderModel> implements OnInit {

  /** Component name */
  componentName = 'CollaboratorOrderCommissionPrintComponent';
  ...
  constructor(
    ...
    public ref: NbDialogRef<CollaboratorOrderCommissionPrintComponent>,
