...
export class CollaboratorRebuyStrategyFormComponent extends DataManagerFormComponent<CollaboratorRebuyStrategyModel> implements OnInit {
      ...
      },
      {
        ...
        cellRendererParams: {
          ...
          clicked: (params: { node: RowNode, data: CollaboratorRebuyStrategyPublisherModel, api: GridApi } & { [key: string]: any }) => {
            ...
            // Setting for product
            this.commonService.openDialog(CollaboratorRebuyStrategyPublisherFormComponent, {
              context: {
                data: [
                  params.data,
                ],
      ...
      },
      {
        ...
        cellRendererParams: {
          ...
          clicked: (params: { node: RowNode, data: CollaboratorRebuyStrategyProductModel, api: GridApi } & { [key: string]: any }) => {
            ...
            // Setting for product
            this.commonService.openDialog(CollaboratorRebuyStrategyProductFormComponent, {
              context: {
                data: [
                  params.data,
                ],
  ...
  public getRowNodeIdForProduct = (item: CollaboratorRebuyStrategyProductModel) => {
    return this.commonService.getObjectId(item.Product);
  }
