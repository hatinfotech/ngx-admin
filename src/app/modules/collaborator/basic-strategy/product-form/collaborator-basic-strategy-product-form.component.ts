...
@Component({
  selector: 'ngx-collaborator-basic-strategy-product-form',
  templateUrl: './collaborator-basic-strategy-product-form.component.html',
  styleUrls: ['./collaborator-basic-strategy-product-form.component.scss'],
  providers: [
    CurrencyPipe
  ]
})
export class CollaboratorBasicStrategyProductFormComponent extends DataManagerFormComponent<CollaboratorBasicStrategyProductModel> implements OnInit {

  componentName: string = 'CollaboratorBasicStrategyProductFormComponent';
  idKey = ['Strategy', 'SystemUuid'];
  apiPath = '/collaborator/basic-strategy/product';
  baseFormUrl = '/collaborator/basic-strategy/product/form';
