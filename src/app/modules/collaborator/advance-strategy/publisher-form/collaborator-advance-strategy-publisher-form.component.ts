...
import { CollaboratorAdvanceStrategyPublisherModel } from '../../../../models/collaborator.model';
...
@Component({
  selector: 'ngx-collaborator-advance-strategy-publisher-form',
  templateUrl: './collaborator-advance-strategy-publisher-form.component.html',
  styleUrls: ['./collaborator-advance-strategy-publisher-form.component.scss'],
  providers: [
    CurrencyPipe
  ]
})
export class CollaboratorAdvanceStrategyPublisherFormComponent extends DataManagerFormComponent<CollaboratorAdvanceStrategyPublisherModel> implements OnInit {

  componentName: string = 'CollaboratorAdvanceStrategyPublisherFormComponent';
  idKey = ['Strategy', 'SystemUuid'];
  apiPath = '/collaborator/advance-strategy/publisher';
  baseFormUrl = '';
  ...
  constructor(
    ...
    public ref?: NbDialogRef<CollaboratorAdvanceStrategyPublisherFormComponent>,
  ...
  async save(): Promise<ProductModel[]> {
    ...
    // }
    // return super.save();
    // return this.getRawFormData().array;
    return null;
  }
  ...
  saveAndClose() {
    this.close();
    this.onDialogSave(this.getRawFormData().array);
    return false;
  }
}
