...
@Component({
  ...
  templateUrl: './collaborator-product-category-form.component.html',
  styleUrls: ['./collaborator-product-category-form.component.scss']
})
export class CollaboratorProductCategoryFormComponent extends DataManagerFormComponent<ProductCategoryModel> implements OnInit {

  componentName: string = 'CollaboratorProductCategoryFormComponent';
  idKey = 'Code';
