import { CollaboratorAddonSaleCommissionConfigurationSellerModel } from '../../../../../models/collaborator.model';
...
import { CollaboratorAddonSaleCommissionConfigurationModel, CollaboratorBasicSaleCommissionConfigurationProductModel } from '../../../../../models/collaborator.model';
...
@Component({
  selector: 'ngx-collaborator-addon-sale-commission-configuration-form',
  templateUrl: './collaborator-addon-sale-commission-configuration-form.component.html',
  styleUrls: ['./collaborator-addon-sale-commission-configuration-form.component.scss'],
  providers: [
    CurrencyPipe
  ]
})
export class CollaboratorAddonSaleCommissionConfigurationFormComponent extends DataManagerFormComponent<CollaboratorAddonSaleCommissionConfigurationModel> implements OnInit {


  componentName: string = 'CollaboratorAddonSaleCommissionConfigurationFormComponent';
  idKey = ['Code'];
  ...
  constructor(
    ...
    public ref?: NbDialogRef<CollaboratorAddonSaleCommissionConfigurationFormComponent>,
  ...
  loadList(callback?: (list: CollaboratorBasicSaleCommissionConfigurationProductModel[]) => void) {
    if (this.gridApi) {
      let publishers: CollaboratorAddonSaleCommissionConfigurationSellerModel[] = (this.array.controls[0].get('Sellers').value || []).map((publisher: CollaboratorAddonSaleCommissionConfigurationSellerModel) => {
  ...
  selectedSellerNode: IRowNode<CollaboratorAddonSaleCommissionConfigurationSellerModel> = null;
  onSellersSelected(nodes: IRowNode<CollaboratorAddonSaleCommissionConfigurationSellerModel>[]) {
