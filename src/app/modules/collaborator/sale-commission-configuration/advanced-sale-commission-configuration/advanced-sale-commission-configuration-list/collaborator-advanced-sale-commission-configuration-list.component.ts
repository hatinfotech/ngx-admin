...
@Component({
  selector: 'ngx-collaborator-advanced-sale-commission-configuration-list',
  templateUrl: './collaborator-advanced-sale-commission-configuration-list.component.html',
  styleUrls: ['./collaborator-advanced-sale-commission-configuration-list.component.scss'],
  providers: [CurrencyPipe, DatePipe],
})
export class CollaboratorAdvancedSaleCommissionConfigurationListComponent extends AgGridDataManagerListComponent<CollaboratorAdvancedSaleCommissionConfigurationModel, CollaboratorAdvancedSaleCommissionConfigurationFormComponent> implements OnInit {

  componentName: string = 'CollaboratorAdvancedSaleCommissionConfigurationListComponent';
  formPath = '';
  ...
  constructor(
    ...
    public ref: NbDialogRef<CollaboratorAdvancedSaleCommissionConfigurationListComponent>,
