...
import { CollaboratorBasicSaleCommissionConfigurationFormComponent } from '../basic-sale-commission-configuration-form/collaborator-basic-sale-commission-configuration-form.component';
import { PageModel } from '../../../../../models/page.model';
import { CurrencyPipe, DatePipe } from '@angular/common';
import { filter, take } from 'rxjs/operators';
import { AppModule } from '../../../../../app.module';
import { CollaboratorBasicSaleCommissionConfigurationModel } from '../../../../../models/collaborator.model';
...
@Component({
  selector: 'ngx-collaborator-basic-sale-commission-configuration-list',
  templateUrl: './collaborator-basic-sale-commission-configuration-list.component.html',
  styleUrls: ['./collaborator-basic-sale-commission-configuration-list.component.scss'],
  providers: [CurrencyPipe, DatePipe],
})
export class CollaboratorBasicSaleCommissionConfigurationListComponent extends AgGridDataManagerListComponent<CollaboratorBasicSaleCommissionConfigurationModel, CollaboratorBasicSaleCommissionConfigurationFormComponent> implements OnInit {

  componentName: string = 'CollaboratorBasicSaleCommissionConfigurationListComponent';
  formPath = '/collaborator/product/form';
  apiPath = '/collaborator/basic-sale-commission-configurations';
  idKey: string | string[] = ['Code'];
  formDialog = CollaboratorBasicSaleCommissionConfigurationFormComponent;
  ...
  constructor(
    ...
    public ref: NbDialogRef<CollaboratorBasicSaleCommissionConfigurationListComponent>,
