...
import { CollaboratorBasicSaleCommissionConfigurationProductModel, CollaboratorBasicSaleCommissionConfigurationModel } from '../../../../../models/collaborator.model';
...
@Component({
  ...
  styleUrls: ['./collaborator-basic-sale-commission-configuration-form.component.scss'],
  providers: [
    CurrencyPipe
  ]
})
export class CollaboratorBasicSaleCommissionConfigurationFormComponent extends DataManagerFormComponent<CollaboratorBasicSaleCommissionConfigurationModel> implements OnInit {


  componentName: string = 'CollaboratorBasicSaleCommissionConfigurationFormComponent';
  idKey = ['Code'];
  ...
  constructor(
    ...
    public ref?: NbDialogRef<CollaboratorBasicSaleCommissionConfigurationFormComponent>,
  ...
  loadList(callback?: (list: CollaboratorBasicSaleCommissionConfigurationProductModel[]) => void) {
    if (this.gridApi) {
      let products: CollaboratorBasicSaleCommissionConfigurationProductModel[] = (this.array.controls[0].get('Products').value || []).map((detail: CollaboratorBasicSaleCommissionConfigurationProductModel) => {
        return detail;
      });
