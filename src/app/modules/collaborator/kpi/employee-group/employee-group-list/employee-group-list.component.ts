...
import { CollaboratorEmployeeGroupFormComponent } from '../employee-group-form/employee-group-form.component';
import { Model } from '../../../../../models/model';


@Component({
  selector: 'ngx-collaborator-employee-group-list',
...
export class CollaboratorEmployeeGroupListComponent extends AgGridDataManagerListComponent<Model, CollaboratorEmployeeGroupFormComponent> implements OnInit {
  ...
  constructor(
    ...
    public ref: NbDialogRef<CollaboratorEmployeeGroupListComponent>,
