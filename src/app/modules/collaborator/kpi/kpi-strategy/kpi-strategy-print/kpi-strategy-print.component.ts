...
@Component({
  selector: 'ngx-collaborator-kpi-strategy-print',
  templateUrl: './kpi-strategy-print.component.html',
  styleUrls: ['./kpi-strategy-print.component.scss']
})
export class CollaboratorKpiStrategyPrintComponent extends DataManagerPrintComponent<Model> implements OnInit, OnChanges {

  /** Component name */
  componentName = 'CollaboratorKpiStrategyPrintComponent';
  ...
  constructor(
    ...
    public ref: NbDialogRef<CollaboratorKpiStrategyPrintComponent>,
    private datePipe: DatePipe,
  ) {
    super(rsv, cms, router, apiService, ref);
    this.processingMap = CollaboratorKpiStrategyListComponent.processingMap;
  }
