...
@Component({
  selector: 'ngx-collaborator-kpi-distributed-contract-print',
  templateUrl: './kpi-distributed-contract-print.component.html',
  styleUrls: ['./kpi-distributed-contract-print.component.scss']
})
export class CollaboratorKpiDistributedContractPrintComponent extends DataManagerPrintComponent<Model> implements OnInit {

  /** Component name */
  componentName = 'CollaboratorKpiDistributedContractPrintComponent';
