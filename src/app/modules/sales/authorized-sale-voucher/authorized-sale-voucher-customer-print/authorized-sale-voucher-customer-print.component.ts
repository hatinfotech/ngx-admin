...
@Component({
  selector: 'ngx-authorized-sale-voucher-customer-print',
  templateUrl: './authorized-sale-voucher-customer-print.component.html',
  styleUrls: ['./authorized-sale-voucher-customer-print.component.scss'],
})
export class AuthorizedSaleVoucherCustomerPrintComponent extends DataManagerPrintComponent<AuthorizedSaleVoucherModel> implements OnInit {

  /** Component name */
  componentName = 'AuthorizedSaleVoucherCustomerPrintComponent';
  title: string = '';
  env = environment;
  ...
  constructor(
    ...
    public ref: NbDialogRef<AuthorizedSaleVoucherCustomerPrintComponent>,
