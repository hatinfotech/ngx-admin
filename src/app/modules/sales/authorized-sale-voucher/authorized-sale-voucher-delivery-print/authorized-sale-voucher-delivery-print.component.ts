...
@Component({
  selector: 'ngx-authorized-sale-voucher-delivery-print',
  templateUrl: './authorized-sale-voucher-delivery-print.component.html',
  styleUrls: ['./authorized-sale-voucher-delivery-print.component.scss'],
})
export class AuthorizedSaleVoucherDeliveryPrintComponent extends DataManagerPrintComponent<AuthorizedSaleVoucherModel> implements OnInit {

  /** Component name */
  componentName = 'AuthorizedSaleVoucherDeliveryPrintComponent';
  title: string = '';
  env = environment;
  ...
  constructor(
    ...
    public ref: NbDialogRef<AuthorizedSaleVoucherDeliveryPrintComponent>,
