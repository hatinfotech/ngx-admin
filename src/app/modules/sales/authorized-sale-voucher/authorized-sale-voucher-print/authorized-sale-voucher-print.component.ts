...
@Component({
  selector: 'ngx-authorized-sale-voucher-print',
  templateUrl: './authorized-sale-voucher-print.component.html',
  styleUrls: ['./authorized-sale-voucher-print.component.scss'],
})
export class AuthorizedSaleVoucherPrintComponent extends DataManagerPrintComponent<AuthorizedSaleVoucherModel> implements OnInit {

  /** Component name */
  componentName = 'AuthorizedSaleVoucherPrintComponent';
  title: string = '';
  env = environment;
  ...
  constructor(
    ...
    public ref: NbDialogRef<AuthorizedSaleVoucherPrintComponent>,
  ...
  async getFormData(ids: string[]) {
    return this.apiService.getPromise<AuthorizedSaleVoucherModel[]>(this.apiPath, { id: ids, includeContact: true, includeObject: true, includeDetails: true, useBaseTimezone: true, includeTax: true, includeUnit: true, includeRelativeVouchers: true, includeSignature: true }).then(rs => {
