...
import { DiscountTableUpdateNoteDetailModel, DiscountTableUpdateNoteModel, SalesMasterPriceTableModel } from '../../../../models/sales.model';
...
import { DiscountTableUpdateNotePrintComponent } from '../discount-table-update-note-print/discount-table-update-note-print.component';
...
@Component({
  selector: 'ngx-discount-table-update-note-form',
  templateUrl: './discount-table-update-note-form.component.html',
  styleUrls: ['./discount-table-update-note-form.component.scss'],
  providers: [DatePipe]
})
export class DiscountTableUpdateNoteFormComponent extends DataManagerFormComponent<DiscountTableUpdateNoteModel> implements OnInit {

  componentName: string = 'DiscountTableUpdateNoteFormComponent';
  idKey = 'Code';
  apiPath = '/sales/discount-update-notes';
  baseFormUrl = '/sales/discount-table-update-note/form';
  previewAfterCreate = true;
  printDialog = DiscountTableUpdateNotePrintComponent;
  ...
  constructor(
    ...
    public ref: NbDialogRef<DiscountTableUpdateNoteFormComponent>,
  ...
  async init(): Promise<boolean> {
    ...
    // if (!DiscountTableUpdateNoteFormComponent._taxList) {
    // } else {
    //   this.taxList = DiscountTableUpdateNoteFormComponent._taxList;
    // }
    ...
    //   return tax;
    // });
    // if (!DiscountTableUpdateNoteFormComponent._unitList) {
    // } else {
    //   this.taxList = DiscountTableUpdateNoteFormComponent._taxList;
    // }
  ...
  /** Execute api get */
  executeGet(params: any, success: (resources: DiscountTableUpdateNoteModel[]) => void, error?: (e: HttpErrorResponse) => void) {
  ...
  async formLoad(formData: DiscountTableUpdateNoteModel[], formItemLoadCallback?: (index: number, newForm: FormGroup, formData: DiscountTableUpdateNoteModel) => void) {
  ...
  makeNewFormGroup(data?: DiscountTableUpdateNoteModel): FormGroup {
  ...
  patchFormGroupValue = (formGroup: FormGroup, data: DiscountTableUpdateNoteModel) => {
  ...
  onAddFormGroup(index: number, newForm: FormGroup, formData?: DiscountTableUpdateNoteModel): void {
  ...
  /** Detail Form */
  makeNewDetailFormGroup(parentFormGroup: FormGroup, data?: DiscountTableUpdateNoteDetailModel): FormGroup {
    let newForm = null;
    newForm = this.formBuilder.group({
      ...
      OldDiscountPercent: { disabled: true, value: null },
  ...
  onAddDetailFormGroup(parentFormGroup: FormGroup, newChildFormGroup: FormGroup, index: number) {
    ...
    newChildFormGroup.get('DiscountPrice').valueChanges.pipe(takeUntil(this.destroy$)).subscribe(value => this.toMoney(parentFormGroup, newChildFormGroup, 'DiscountPrice'));
    newChildFormGroup.get('DiscountPercent').valueChanges.pipe(takeUntil(this.destroy$)).subscribe(value => this.toMoney(parentFormGroup, newChildFormGroup, 'DiscountPercent'));
