...
import { DiscountTableUpdateNoteModel } from '../../../../models/sales.model';
...
@Component({
  selector: 'ngx-discount-table-update-note-list',
  templateUrl: './discount-table-update-note-list.component.html',
  styleUrls: ['./discount-table-update-note-list.component.scss'],
})
export class DiscountTableUpdateNoteListComponent extends AgGridDataManagerListComponent<DiscountTableUpdateNoteModel, DiscountTableUpdateNoteFormComponent> implements OnInit {

  componentName: string = 'DiscountTableUpdateNoteListComponent';
  formPath = '/sales/discount-update-notes/form';
  ...
  constructor(
    ...
    public ref: NbDialogRef<DiscountTableUpdateNoteListComponent>,
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: DiscountTableUpdateNoteModel[]) => void, onDialogClose?: () => void) {
