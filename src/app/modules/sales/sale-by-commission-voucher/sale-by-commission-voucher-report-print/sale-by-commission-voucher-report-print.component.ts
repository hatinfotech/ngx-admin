...
@Component({
  selector: 'ngx-sale-by-commission-voucher-report-print',
  templateUrl: './sale-by-commission-voucher-report-print.component.html',
  styleUrls: ['./sale-by-commission-voucher-report-print.component.scss'],
  providers: [CurrencyPipe]
})
export class SaleByCommissionVoucherReportPrintComponent extends DataManagerPrintComponent<CashVoucherModel> implements OnInit {

  /** Component name */
  componentName = 'SaleByCommissionVoucherReportPrintComponent';
  ...
  constructor(
    ...
    public ref: NbDialogRef<SaleByCommissionVoucherReportPrintComponent>,
