...
export class SalesReturnsVoucherListComponent extends ServerDataManagerListComponent<SalesReturnsVoucherModel> implements OnInit {
  ...
  loadListSetting(): SmartTableSetting {
    return this.configSetting({
      ...
      columns: {
        ...
        DateOfReturn: {
          title: this.commonService.textTransform(this.commonService.translate.instant('Sales.dateOfReturns'), 'head-title'),
          type: 'custom',
          width: '15%',
          filter: {
            type: 'custom',
            ...
            instance.click.pipe(takeUntil(this.destroy$)).subscribe((rowData: SalesReturnsVoucherModel) => {
              ...
              this.commonService.openDialog(ResourcePermissionEditComponent, {
                context: {
                  ...
                  resourceName: this.commonService.translateText('Sales.SalesReturnsVoucher  .title', { action: '', definition: '' }) + ` ${rowData.Title || ''}`,
                  // resrouce: rowData,
  ...
  //   this.commonService.openDialog(SalesReturnsVoucherPrintComponent, {
  //     context: {
  //       showLoadinng: true,
  //       title: 'Xem trước',
