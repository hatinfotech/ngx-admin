...
export class SalesReturnsVoucherListComponent extends AgGridDataManagerListComponent<SalesReturnsVoucherModel, SalesReturnsVoucherFormComponent> implements OnInit {
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: SalesReturnsVoucherModel[]) => void, onDialogClose?: () => void) {
