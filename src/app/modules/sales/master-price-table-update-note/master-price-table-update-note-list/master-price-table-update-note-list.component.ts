...
@Component({
  selector: 'ngx-master-price-table-update-note-list',
  templateUrl: './master-price-table-update-note-list.component.html',
  styleUrls: ['./master-price-table-update-note-list.component.scss'],
})
export class MasterPriceTableUpdateNoteListComponent extends AgGridDataManagerListComponent<MasterPriceTableUpdateNoteModel, MasterPriceTableUpdateNoteFormComponent> implements OnInit {

  componentName: string = 'MasterPriceTableUpdateNoteListComponent';
  formPath = '/sales/master-price-table-update-note/form';
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: MasterPriceTableUpdateNoteModel[]) => void, onDialogClose?: () => void) {
