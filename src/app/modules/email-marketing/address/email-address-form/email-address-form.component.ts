...
import { UploaderOptions, UploadFile, UploadInput, UploadOutput, humanizeBytes } from '../../../../lib/ngx-uploader/public_api';
...
export class EmailAddressFormComponent extends DataManagerFormComponent<EmailAddressListModel> implements OnInit {
  ...
  constructor(
    ...
    protected ref: NbDialogRef<EmailAddressFormComponent>,
  ) {
