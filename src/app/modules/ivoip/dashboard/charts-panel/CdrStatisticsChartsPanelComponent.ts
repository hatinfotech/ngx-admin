...
export class CdrStatisticsChartsPanelComponent implements OnInit, OnDestroy {
  ...
  componentName: string = 'CdrStatisticsChartsPanelComponent';
  private alive = true;
  ...
  getOrdersChartData(period: string) {
    ...
    }[]>('/ivoip/cdrs', { limit: 99999999999, statistics: period, domainId: this.ivoipService.getPbxActiveDomainUuid() }, result => {
