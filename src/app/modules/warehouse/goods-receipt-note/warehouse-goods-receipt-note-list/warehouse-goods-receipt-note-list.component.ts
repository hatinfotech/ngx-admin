...
export class WarehouseGoodsReceiptNoteListComponent extends AgGridDataManagerListComponent<WarehouseGoodsReceiptNoteModel, WarehouseGoodsReceiptNoteFormComponent> implements OnInit {
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: WarehouseGoodsReceiptNoteModel[]) => void, onDialogClose?: () => void) {
