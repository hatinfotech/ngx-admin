...
@Component({
  selector: 'ngx-warehouse-find-order-temp-print',
  templateUrl: './warehouse-find-order-temp-print.component.html',
  styleUrls: ['./warehouse-find-order-temp-print.component.css'],
})
export class WarehouseFindOrderTempPrintComponent extends DataManagerPrintComponent<any> implements OnInit {

  /** Component name */
  componentName = 'WarehouseFindOrderTempPrintComponent';
  title: string = 'Tem nhận thức';
  env = environment;
...
.blabel {
  ...
  constructor(
    ...
    public ref: NbDialogRef<WarehouseFindOrderTempPrintComponent>,
