...
@Component({
  ...
  templateUrl: './detail-by-object-report-ag.component.html',
  styleUrls: ['./detail-by-object-report-ag.component.scss']
})
export class WarehouseDetailByObjectReportAgComponent extends AgGridDataManagerListComponent<AccountModel, any> implements OnInit {

  componentName: string = 'WarehouseDetailByObjectReportAgComponent';
  ...
  constructor(
    ...
    public ref: NbDialogRef<WarehouseDetailByObjectReportAgComponent>,
  ...
  prepareApiParams(params: any, getRowParams: IGetRowsParams) {
    ...
    const choosedFromDate = (this.warehouseService.reportFromDate$.value as Date) || new Date();
    const fromDate = new Date(choosedFromDate.getFullYear(), choosedFromDate.getMonth(), choosedFromDate.getDate(), 0, 0, 0, 0);

    const choosedToDate = (this.warehouseService.reportToDate$.value as Date) || new Date();
