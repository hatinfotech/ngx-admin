...
@Component({
  ...
  templateUrl: './warehouse-detail-by-goods-report.component.html',
  styleUrls: ['./warehouse-detail-by-goods-report.component.scss']
})
export class WarehouseDetailByGoodsReportComponent extends ServerDataManagerListComponent<AccountModel> implements OnInit {

  componentName: string = 'WarehouseDetailByGoodsReportComponent';
