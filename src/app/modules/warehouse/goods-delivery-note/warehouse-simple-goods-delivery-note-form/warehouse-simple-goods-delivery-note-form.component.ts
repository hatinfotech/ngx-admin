...
import { WarehouseGoodsDeliveryNoteModel, WarehouseModel, WarehouseGoodsContainerModel, WarehouseGoodsDeliveryNoteDetailModel, GoodsModel } from '../../../../models/warehouse.model';
...
@Component({
  selector: 'ngx-warehouse-simple-goods-delivery-note-form',
  templateUrl: './warehouse-simple-goods-delivery-note-form.component.html',
  styleUrls: ['./warehouse-simple-goods-delivery-note-form.component.scss'],
})
export class WarehouseSimpleGoodsDeliveryNoteFormComponent extends DataManagerFormComponent<WarehouseGoodsDeliveryNoteModel> implements OnInit {

  componentName: string = 'WarehouseSimpleGoodsDeliveryNoteFormComponent';
  idKey = 'Code';
  ...
  constructor(
    ...
    public ref: NbDialogRef<WarehouseSimpleGoodsDeliveryNoteFormComponent>,
  ) {
  ...
  preview(formItem: FormGroup) {
    const data: WarehouseGoodsDeliveryNoteModel = formItem.getRawValue();
