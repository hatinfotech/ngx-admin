...
export class WarehouseGoodsDeliveryNoteListComponent extends AgGridDataManagerListComponent<WarehouseGoodsDeliveryNoteModel, WarehouseGoodsDeliveryNoteFormComponent> implements OnInit {
  ...
  async init() {
    return super.init().then(async state => {
      ...
      const processingMap = AppModule.processMaps['warehouseDeliveryGoodsNote'];
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: WarehouseGoodsDeliveryNoteModel[]) => void, onDialogClose?: () => void) {
