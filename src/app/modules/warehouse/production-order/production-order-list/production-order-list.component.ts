...
import { ProductionOrderPrintComponent } from '../production-order-print/production-order-print.component';
...
@Component({
  selector: 'ngx-production-order-list',
  templateUrl: './production-order-list.component.html',
  styleUrls: ['./production-order-list.component.scss'],
})
export class ProductionOrderListComponent extends AgGridDataManagerListComponent<ProductionOrderModel, ProductionOrderFormComponent> implements OnInit {

  componentName: string = 'ProductionOrderListComponent';
  formPath = '/warehouse/production-order/form';
  ...
  constructor(
    ...
    public ref: NbDialogRef<ProductionOrderListComponent>,
  ...
  async init() {
    return super.init().then(async state => {
      ...
      const processingMap = AppModule.processMaps['warehouseReceiptGoodsNote'];
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: ProductionOrderModel[]) => void, onDialogClose?: () => void) {
    this.cms.openDialog(ProductionOrderFormComponent, {
      context: {
        inputMode: 'dialog',
        inputId: ids,
        onDialogSave: (newData: ProductionOrderModel[]) => {
