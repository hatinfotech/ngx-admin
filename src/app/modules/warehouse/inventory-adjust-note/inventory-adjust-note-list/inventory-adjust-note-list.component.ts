...
export class WarehouseInventoryAdjustNoteListComponent extends AgGridDataManagerListComponent<WarehouseInventoryAdjustNoteModel, WarehouseInventoryAdjustNoteFormComponent> implements OnInit {
  ...
  async init() {
    return super.init().then(async state => {
      ...
      this.columnDefs = this.configSetting([
        ...
        {
          headerName: 'Ngày kiểm kho',
          field: 'DateOfAdjusted',
          width: 180,
  ...
  /** Implement required */
  openFormDialplog(ids?: string[], onDialogSave?: (newData: WarehouseInventoryAdjustNoteModel[]) => void, onDialogClose?: () => void) {
